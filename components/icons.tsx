...
export const SurbeeLogo = ({ className }: { className?: string }) => {
  return (
    <svg
      viewBox="0 0 100 100"
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M63.3,2.9C61.2,1.1,58.3,0,55.1,0H44.9C41.7,0,38.8,1.1,36.7,2.9L14.1,21.4c-2.1,1.8-3.4,4.3-3.4,7.1v43 c0,2.8,1.3,5.3,3.4,7.1l22.6,18.5c2.1,1.8,5,2.9,8.2,2.9h10.2c3.2,0,6.1-1.1,8.2-2.9l22.6-18.5c2.1-1.8,3.4-4.3,3.4-7.1v-43 c0-2.8-1.3-5.3-3.4-7.1L63.3,2.9z M54.4,26.9c0-2.4-1.9-4.3-4.3-4.3s-4.3,1.9-4.3,4.3v10.8c0,2.4,1.9,4.3,4.3,4.3s4.3-1.9,4.3-4.3 V26.9z M37.6,46.4c-2.4,0-4.3,1.9-4.3,4.3s1.9,4.3,4.3,4.3h24.8c2.4,0,4.3-1.9,4.3-4.3s-1.9-4.3-4.3-4.3H37.6z M50,59.4 c-2.4,0-4.3,1.9-4.3,4.3v10.8c0,2.4,1.9,4.3,4.3,4.3s4.3-1.9,4.3-4.3V63.7C54.4,61.3,52.4,59.4,50,59.4z" />
    </svg>
  );
};
