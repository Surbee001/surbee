...
import { CornerDownLeftIcon, FunctionSquareIcon } from 'lucide-react';
import {
          ...
          >
            {props.element.texExpression.length > 0 ? (
              ...
              <div className="flex h-7 w-full items-center gap-2 text-sm whitespace-nowrap text-muted-foreground">
                <FunctionSquareIcon className="size-6 text-muted-foreground/80" />
      ...
      <Popover open={open} onOpenChange={setOpen} modal={false}>
        <PopoverTrigger asChild>
          ...
          >
            ...
            {element.texExpression.length === 0 && (
              <span>
                <FunctionSquareIcon className="mr-1 inline-block h-[19px] w-4 py-[1.5px] align-text-bottom" />
                New equation
              </span>
            )}
          </div>
