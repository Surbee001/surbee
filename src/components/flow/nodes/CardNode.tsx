...
export default function CardNode({ data }: NodeProps) {
  return (
    <div className="rounded-lg border border-zinc-800 bg-[#1a1a1a] text-gray-200 w-[260px]">
      <div className="px-3 py-2 border-b border-zinc-800 text-sm font-medium">{data.title ?? "Card"}</div>
      <div className="px-3 py-3 text-sm text-gray-300">
        <div className="bg-[#171717] border border-zinc-800 rounded-md px-2 py-1">{data.content ?? ""}</div>
      </div>
