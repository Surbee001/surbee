    ...
    >
      <div
        ...
        style={{
          ...
          scrollbarColor: 'var(--surbee-scrollbar) transparent',
          scrollbarWidth: 'thin',
        }}
        ...
        {isLoading ? (
          ...
          <>
            ...
            {filteredSurveys.length > 0 && (
              <div className="mb-4">
                <p className="text-xs font-medium mb-2 uppercase tracking-wider" style={{ color: 'var(--surbee-fg-muted)' }}>
                  Surveys
                </p>
                      ...
                      <div className="flex gap-4">
                        ...
                        >
                          ...
                          >
                            {item.previewUrl ? (
                              ...
                              <svg height="24" width="24" viewBox="0 0 16 16" fill="currentColor" style={{ color: 'var(--surbee-dropdown-text-muted)', margin: '0 auto', display: 'block' }}>
                        ...
                        <div className="flex-1 overflow-hidden" style={{ maxWidth: '580px' }}>
                          <header style={{ marginBottom: '4px' }}>
                            ...
                            <p 
                              className="text-sm"
                              style={{ color: 'var(--surbee-dropdown-text-muted)' }}
                            >
