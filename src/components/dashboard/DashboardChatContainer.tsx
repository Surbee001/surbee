                ...
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                      viewBox="0 0 16 16"
                      style={{ color: selectedCreateType ? '#0285ff' : 'var(--surbee-fg-muted)' }}
                    >
                      <path
                ...
                >
                  <div className="flex items-start gap-3 w-full">
                    <div className="flex h-5 items-center justify-center -ml-1 -mr-1 min-w-6">
                      <svg height="18" width="18" viewBox="0 0 16 16" style={{ color: 'var(--surbee-dropdown-text-muted)' }}>
                    ...
                    <div className="flex flex-col w-full">
                      ...
                      <p className="text-sm" style={{ color: 'var(--surbee-dropdown-text-muted)' }}>Build and publish surveys</p>
                    </div>
                  </div>
                </DropdownMenuItem>
                ...
                >
                  <div className="flex items-start gap-3 w-full">
                    ...
                    <div className="flex flex-col w-full">
                      ...
                      <p className="text-sm" style={{ color: 'var(--surbee-dropdown-text-muted)' }}>Generate data visualizations</p>
                    </div>
                  </div>
                </DropdownMenuItem>
              </DropdownMenuContent>
                    ...
                    >
                      <div className="flex items-center gap-3 w-full">
                        ...
                        <div
                          ...
                          style={{ backgroundColor: searchWebEnabled ? '#0285ff' : 'var(--surbee-border-primary)' }}
                        >
                          <div
