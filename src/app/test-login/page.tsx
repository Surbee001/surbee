        ...
        <div className="relative flex items-center justify-center p-6 md:p-10">
          ...
          <div className="mx-auto flex w-full max-w-sm flex-col items-center text-center">
            ...
            <div className="w-full space-y-3">
              <a href="/onboarding?step=1&mode=google" aria-label="Continue with Google" className="h-11 w-full bg-zinc-900 text-zinc-100 px-5 text-sm font-medium hover:bg-zinc-800 transition inline-flex items-center justify-center" style={{ borderRadius: '12px' }}>
              ...
              <a href="/onboarding?step=1&mode=email" aria-label="Log in" className="h-11 w-full bg-zinc-900 text-zinc-100 px-5 text-sm font-medium hover:bg-zinc-800 transition inline-flex items-center justify-center" style={{ borderRadius: '12px' }}>
                Log in
              </a>
            </div>
