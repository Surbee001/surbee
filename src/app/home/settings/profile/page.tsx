        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 h-full max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-1">
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                {[
                  { icon: User, label: 'Profile', active: true, href: '/home/settings/profile' },
                  { icon: Settings, label: 'Appearance', active: false, href: '/home/settings' },
                  { icon: Bell, label: 'Notifications', active: false, href: '/home/settings/notifications' },
                  { icon: Shield, label: 'Privacy & Security', active: false, href: '/home/settings/privacy' },
                  { icon: CreditCard, label: 'Billing & Plans', active: false, href: '/home/settings/billing' },
                  { icon: HelpCircle, label: 'Help', active: false, href: '/home/settings/account' },
                ].map((item) => {
