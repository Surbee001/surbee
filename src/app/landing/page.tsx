              ...
              {/* Centered overlay prompt card */}
                ...
                >
                  <div className="relative inline-block">
                    <div className="rounded-lg px-4 pt-3 pb-2 backdrop-blur-lg max-w-[calc(100vw_-_64px)] w-[512px] flex flex-col items-start justify-start gap-2 h-[110px] bg-gradient-to-b from-[rgba(255,255,255,0.80)] to-[rgba(255,255,255,0.16)] shadow-[0px_4px_12px_0px_rgba(255,255,255,0.10)_inset,0px_0px_0px_6px_rgba(255,255,255,0.40),0px_1px_8px_0px_rgba(0,0,0,0.13),0px_2px_6px_0px_rgba(0,0,0,0.20)] transition-all duration-300">
                      ...
                      <div className="mt-auto flex flex-row gap-4 items-center justify-between w-full">
